    ...
    def run(self):
        ...
        while running:
            ...
            if ret:
                ...
                img_result = transformer.predict(np_image[tf.newaxis, :, :, :])[0].astype('uint8')

                qImg = QtGui.QImage(img.data, w, h, w * c, QtGui.QImage.Format_RGB888)
                qImg2 = QtGui.QImage(img_result.data, w, h, w * c, QtGui.QImage.Format_RGB888)
                ...
                self.saveButton.clicked.connect(cv2.imwrite('save/changed.jpg', qImg2))
